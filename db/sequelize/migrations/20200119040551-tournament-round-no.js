...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return Promise
      .resolve()
      .then(function() {
        return queryInterface.addColumn("tournament_ranks", "currentRoundNo", {
          after: "score",
          type: "INTEGER",
          allowNull: false,
          defaultValue: 0
      ...
      .then(function() {
        return queryInterface.addColumn("tournaments", "currentRoundNo", {
          after: "playerCount",
          type: "INTEGER",
          allowNull: false,
          defaultValue: 0
      ...
      .then(function() {
        return queryInterface.addColumn("tournaments", "featured", {
          after: "startingAt",
          type: "BOOLEAN",
          allowNull: false,
          defaultValue: false
  ...
  down: function(queryInterface, Sequelize) {
    return Promise
      .resolve()
      .then(function() {
        return queryInterface.removeColumn("tournaments", "featured");
      })

      .then(function() {
        return queryInterface.removeColumn("tournaments", "currentRoundNo");
      })

      .then(function() {
        return queryInterface.removeColumn("tournament_ranks", "currentRoundNo");
      });
  },
