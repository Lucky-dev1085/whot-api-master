...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return Promise
      .resolve()
      .then(function() {
        return queryInterface.renameColumn("player_details", 'withdrawlBalance', 'withdrawalBalance');
      });
  },
  ...
  down: function(queryInterface, Sequelize) {
    return Promise
      .resolve()
      .then(function() {
        return queryInterface.renameColumn("player_details", 'withdrawalBalance', 'withdrawlBalance');
      });
  },
