...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return Promise
      ...
      .then(function() {
        return queryInterface.changeColumn("chat_messages", "type", {
          type: "VARCHAR(255)",
          allowNull: true
        });
      })
      ...
      .then(function() {
        return queryInterface.changeColumn("chat_messages", "contentUrl", {
          type: "VARCHAR(255)",
          allowNull: true
        });
      })
      ...
      .then(function() {
        return queryInterface.changeColumn("chat_messages", "contentType", {
          type: "VARCHAR(255)",
          allowNull: true
        });
      });
