...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return Promise
      .resolve()
      .then(function() {
        return queryInterface.changeColumn("game_tables", "gameStatus", {
          type: "VARCHAR(255)",
          allowNull: true,
      ...
      .then(function() {
        return queryInterface.sequelize.query(
          `
          UPDATE game_tables SET "gameStatus" = 'notStarted' WHERE "gameStatus" = 'NEW';
          UPDATE game_tables SET "gameStatus" = 'ended' WHERE "gameStatus" != 'notStarted';
          `
        );
      })

      .then(function() {
        return queryInterface.changeColumn("player_bank_accounts", "verifiedAt", {
