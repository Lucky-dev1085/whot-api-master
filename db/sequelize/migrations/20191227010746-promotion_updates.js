...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return Promise
      .resolve()
      .then(function() {
        return queryInterface.removeIndex("promotions", ["searchKeywords"]);
      })

      .then(function() {
        return queryInterface.removeColumn("promotions", "searchKeywords");
      })

      .then(function() {
        return queryInterface.changeColumn("promotions", "batchName", {
          type: "VARCHAR(255)",
          allowNull: false,
          defaultValue: ""
        });
      ...
      .then(function() {
        return queryInterface.changeColumn("promotions", "denomination", {
          type: "FLOAT",
          allowNull: false,
          defaultValue: 100
        });
      ...
      .then(function() {
        return queryInterface.changeColumn("promotions", "numberOfCodes", {
          type: "INTEGER",
          allowNull: false,
          defaultValue: 1
        });
      ...
      .then(function() {
        return queryInterface.changeColumn("promotions", "expiresAt", {
      ...
      .then(function() {
        return queryInterface.addColumn("promotions", "createdBy", {
          after: "batchName",
          type: "VARCHAR(255)",
          allowNull: false
        });
      ...
      .then(function() {
        return queryInterface.addColumn("promotions", "usageCountPerCode", {
          after: "numberOfCodes",
          type: "INTEGER",
          allowNull: false,
          defaultValue: 1
      ...
      .then(function() {
        return queryInterface.addColumn("promotions", "playerDetailId", {
          after: "updatedAt",
          type: "INTEGER",
          allowNull: true,
      ...
      .then(function() {
        return queryInterface.addColumn("promotions", "userId", {
          after: "playerDetailId",
          type: "INTEGER",
          allowNull: true,
      ...
      .then(function() {
        return queryInterface.addIndex("promotions", { fields: ["createdBy"] });
      });
  },
  ...
  down: function(queryInterface, Sequelize) {
    return Promise
      .resolve()
      .then(function() {
        return queryInterface.removeIndex("promotions", ["createdBy"]);
      })

      .then(function() {
        return queryInterface.removeColumn("promotions", "userId");
      })

      .then(function() {
        return queryInterface.removeColumn("promotions", "playerDetailId");
      })

      .then(function() {
        return queryInterface.removeColumn("promotions", "usageCountPerCode");
      })

      .then(function() {
        return queryInterface.removeColumn("promotions", "createdBy");
      })
      ...
      .then(function() {
        return queryInterface.addColumn("promotions", "searchKeywords", {
          after: "expiresAt",
          type: "TEXT",
          allowNull: true
        });
      ...
      .then(function() {
        return queryInterface.addIndex("promotions", {
