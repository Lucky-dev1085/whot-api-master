...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return Promise
      ...
      .then(function() {
        return queryInterface.addIndex("tournaments", { fields: ["state"] });
      })

      .then(function() {
        return queryInterface.addIndex("tournaments", {
          fields: ["startingAt"]
        });
      })
      ...
      .then(function() {
        return queryInterface.addIndex("tournament_ranks", {
          fields: ["state"]
        });
      })
      ...
      .then(function() {
        return queryInterface.addColumn("game_tables", "tournamentId", {
  ...
  down: function(queryInterface, Sequelize) {
    return Promise
      .resolve()
      .then(function() {
        return queryInterface.removeColumn("game_tables", "tournamentId");
      })

      .then(function() {
        return queryInterface.dropTable("tournament_ranks");
      })
