...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return Promise.resolve()
      ...
      .then(function() {
        return queryInterface.addIndex("banks", { fields: ["name"] });
      })
      ...
      .then(function() {
        return queryInterface.addIndex("player_bank_accounts", {
          fields: ["verifiedAt"]
        });
      });
  },
  ...
  down: function(queryInterface, Sequelize) {
    return Promise.resolve()
      .then(function() {
        return queryInterface.dropTable("player_bank_accounts");
      })
